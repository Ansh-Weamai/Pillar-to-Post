...
> = {
  unchecked: { label: "Awaiting evidence", icon: Circle, className: "text-ink-soft", iconClassName: "" },
  confirmed: { label: "Confirmed", icon: CheckCircle2, className: "text-status-confirmed", iconClassName: "fill-status-confirmed-tint" },
  partial: { label: "Not visible", icon: AlertTriangle, className: "text-status-partial", iconClassName: "fill-status-partial-tint" },
  missing: { label: "Missing", icon: XCircle, className: "text-status-missing", iconClassName: "fill-status-missing-tint" },
};
